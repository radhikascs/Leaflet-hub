...
//			console.log('removing this')
	...
	_updateContent: function () {
		...
		if (typeof this._content === 'string') {
			...
			// Nath changed Dec 23
		    this._container.innerHTML = '<a class="closeButton"></a>' + this._content;
...
L.BaseMarkerMethods = {
	...
	// Nath changes on Dec 23
		this
			.on('click', this.showLabel, this)		
