...
impactStudies.showPopUp = function(layerFeature) {
	...
	if (dureApp.impactStudiesCountries[impactStudies.countryId] != undefined) {
		...
		$('#coloum-filter-template').append(impactStudies.buildOptionSelect('impactStudies.onChangeColFilter()','impact-study-colfilter', 'Coloum Filter'));
	...
	var eligibleFilters = ["Please Choose", "OUTCOMES", "Products Evaluated", "Dosing Schedule", "Target Population", "STUDY DESIGN", "Time Series"];
